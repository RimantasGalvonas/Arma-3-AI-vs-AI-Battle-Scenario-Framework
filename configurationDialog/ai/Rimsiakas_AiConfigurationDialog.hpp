class Rimsiakas_AiConfigurationDialog
{
    ...
    {
        idc = AI_CONFIG_PATROLFORMATIONLABEL_IDC;
    ...
    {
        idc = AI_CONFIG_PATROLFORMATION_IDC;
        x = 10 * GUI_GRID_W + GUI_GRID_X;
    ...
    {
        idc = AI_CONFIG_ATTACKFORMATIONLABEL_IDC;
    ...
    {
        idc = AI_CONFIG_ATTACKFORMATION_IDC;
        x = 10 * GUI_GRID_W + GUI_GRID_X;
    ...
    {
        idc = AI_CONFIG_MOVEMENTSPEEDMODELABEL_IDC;
    ...
    {
        idc = AI_CONFIG_MOVEMENTSPEEDMODE_IDC;
        x = 10 * GUI_GRID_W + GUI_GRID_X;
    ...
    {
        idc = AI_CONFIG_ATTACKSPEEDOVERRIDELABEL_IDC;
    ...
    {
        idc = AI_CONFIG_ATTACKSPEEDOVERRIDE_IDC;
    ...
    {
        idc = AI_CONFIG_ALLOWGROUPJOININGLABEL_IDC;
    ...
    {
        idc = AI_CONFIG_ALLOWGROUPJOINING_IDC;
    ...
    {
        idc = AI_CONFIG_FORCEKEEPFORMATIONLABEL_IDC;
    ...
    {
        idc = AI_CONFIG_FORCEKEEPFORMATION_IDC;
    ...
    {
        idc = AI_CONFIG_CONFIRMBUTTON_IDC;
        text = "Confirm";
