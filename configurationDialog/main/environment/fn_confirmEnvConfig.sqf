...
[_newDate] remoteExecCall ["setDate"];

[0, parseNumber (ctrlText MAIN_CONFIG_ENV_OVERCASTFIELD_IDC) / 100] remoteExecCall ["setOvercast"];
[0, parseNumber (ctrlText MAIN_CONFIG_ENV_FOGFIELD_IDC) / 100] remoteExecCall ["setFog"];
